...
if($detail_look==2) {
    ...
    if(isset($blog_setting['comments']['wordpress'])) $article_meta.='<a class="comments" href="'.get_comments_link().'">'.file_get_contents(__DIR__."/images/comments.svg").$comments .'</a>';    
} else {
...
if($detail_look==2) { 
  ...
  if(strpos($thumb_id, 'http') !== false) $article_thumb_bg=$thumb_id;
  else $article_thumb_bg=get_the_post_thumbnail_url($post->ID);
?>
<div class="single_blog_title_container" style="background-image: url('<?php echo $article_thumb_bg; ?>');">
    ...
    <div id="blog-content">
      ...
      <div class="blog-box blog-singlebox article-detail">
        ...
        <div class="author-box">
            ...
            if($desc) echo '<div class="author_box_description">'.$desc.'</div>';
            ?>
      </div>
      <?php 
      }   
      ...
      <div id="blog_comments_container"><?php $blog_module->print_blog_comments(3); ?></div> 
