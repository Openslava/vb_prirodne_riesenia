...
$web=array(
    ...
    'demo'=>'http://demo-portfolio1.mioweb.cz',
    'tags'=>array('personal','portfolio','photographer'),
    'modules'=>array('blog'),
    'thumb'=>get_template_directory_uri().'/modules/visualeditor/web_templates/portfolio1/thumb.jpg',
    'thumb_en'=>get_template_directory_uri().'/modules/visualeditor/web_templates/portfolio1/thumb_en.jpg',
    'home'=>'page', 
    // list of web pages   
    'pages'=>array(
        'story'=>array(
